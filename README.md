...
This project Overview in Sonar Cloud can be access at [Overview Project in Sonar Cloud](https://sonarcloud.io/project/overview?id=alexfariakof_despesas-backend-api-net-core](https://sonarcloud.io/project/overview?id=alexfariakof_app-despesas-pessoais)) 
