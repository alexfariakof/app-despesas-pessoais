        ...
        if (!_context.Despesa.Any())
        {
            ...
            var despesas = new List<Despesa>
            {
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 2, 1),
                    Descricao = "Aluguel",
                    Valor = 800.95m,
                    DataVencimento = new DateTime(2025, 2, 10),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Alimentação")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 2, 2),
                    Descricao = "Compra de roupas",
                    Valor = 100.95m,
                    DataVencimento = new DateTime(2025, 2, 15),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Descricao = "Consulta Médica",
                    Valor = 250.95m,
                    DataVencimento = new DateTime(2025, 2, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
                new Despesa
                {
                    ...
                    Descricao = "Imposto de Renda",
                    Valor = 350.95m,
                    DataVencimento = new DateTime(2025, 2, 5),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Imposto")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 3, 01),
                    Descricao = "Conta de Água",
                    Valor = 100.95m,
                    DataVencimento = new DateTime(2025, 3, 10),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 3, 03),
                    Descricao = "Serviço de Jardinagem",
                    Valor = 120.95m,
                    DataVencimento = new DateTime(2025, 3, 20),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 3, 04),
                    Descricao = "Consulta Médica",
                    Valor = 150.95m,
                    DataVencimento = new DateTime(2025, 3, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 4, 01),
                    Descricao = "Refeição Ifood",
                    Valor = 80.95m,
                    DataVencimento = new DateTime(2025, 4, 10),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Alimentação")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 4, 02),
                    Descricao = "Compra de Móveis",
                    Valor = 700.95m,
                    DataVencimento = new DateTime(2025, 4, 15),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 4, 03),
                    Descricao = "Serviço de Encanamento",
                    Valor = 90.95m,
                    DataVencimento = new DateTime(2025, 4, 20),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 4, 04),
                    Descricao = "Consulta Médica",
                    Valor = 180.95m,
                    DataVencimento = new DateTime(2025, 4, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 4, 05),
                    Descricao = "Imposto de Renda",
                    Valor = 200.95m,
                    DataVencimento = new DateTime(2025, 4, 05),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Imposto")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 5, 01),
                    Descricao = "Almoço Restaurante",
                    Valor = 120.95m,
                    DataVencimento = new DateTime(2025, 5, 10),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Alimentação")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 5, 02),
                    Descricao = "Compra de Eletrodomésticos",
                    Valor = 800.95m,
                    DataVencimento = new DateTime(2025, 5, 15),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 5, 03),
                    Descricao = "Serviço de Pintura",
                    Valor = 200.95m,
                    DataVencimento = new DateTime(2025, 5, 20),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 5, 04),
                    Descricao = "Consulta Médica",
                    Valor = 150.95m,
                    DataVencimento = new DateTime(2025, 5, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 5, 05),
                    Descricao = "Imposto de Renda",
                    Valor = 400.95m,
                    DataVencimento = new DateTime(2025, 5, 05),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Imposto")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 6, 01),
                    Descricao = "Pedido Ifood",
                    Valor = 90.95m,
                    DataVencimento = new DateTime(2025, 6, 10),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Alimentação")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 6, 02),
                    Descricao = "Compra de Livros",
                    Valor = 60.95m,
                    DataVencimento = new DateTime(2025, 6, 15),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 6, 03),
                    Descricao = "Serviço de Manicure",
                    Valor = 40.95m,
                    DataVencimento = new DateTime(2025, 6, 20),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 6, 04),
                    Descricao = "Consulta Médica",
                    Valor = 120.95m,
                    DataVencimento = new DateTime(2025, 6, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 6, 05),
                    Descricao = "Imposto de Renda",
                    Valor = 300.95m,
                    DataVencimento = new DateTime(2025, 6, 05),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Imposto")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 7, 01),
                    Descricao = "Refeição Ifood",
                    Valor = 150.95m,
                    DataVencimento = new DateTime(2025, 7, 10),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Alimentação")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 7, 02),
                    Descricao = "Compra de Roupas",
                    Valor = 200.95m,
                    DataVencimento = new DateTime(2025, 7, 15),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 7, 03),
                    Descricao = "Serviço de Limpeza",
                    Valor = 80.95m,
                    DataVencimento = new DateTime(2025, 7, 20),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 7, 04),
                    Descricao = "Consulta Médica",
                    Valor = 100.95m,
                    DataVencimento = new DateTime(2025, 7, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 7, 05),
                    Descricao = "Imposto de Renda",
                    Valor = 250.95m,
                    DataVencimento = new DateTime(2025, 7, 05),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Imposto")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 8, 01),
                    Descricao = "Almoço no Restaurante",
                    Valor = 100.95m,
                    DataVencimento = new DateTime(2025, 8, 10),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Alimentação")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 8, 02),
                    Descricao = "Compra de Eletrônicos",
                    Valor = 500.95m,
                    DataVencimento = new DateTime(2025, 8, 15),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 8, 03),
                    Descricao = "Serviço de Jardinagem",
                    Valor = 120.95m,
                    DataVencimento = new DateTime(2025, 8, 20),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 8, 04),
                    Descricao = "Consulta Médica",
                    Valor = 80.95m,
                    DataVencimento = new DateTime(2025, 8, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 8, 05),
                    Descricao = "Imposto de Renda",
                    Valor = 350.95m,
                    DataVencimento = new DateTime(2025, 8, 05),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Imposto")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 9, 01),
                    Descricao = "Conta de Telefone",
                    Valor = 50.95m,
                    DataVencimento = new DateTime(2025, 9, 10),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 9, 02),
                    Descricao = "Aluguel",
                    Valor = 800.95m,
                    DataVencimento = new DateTime(2025, 9, 15),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 9, 03),
                    Descricao = "Manutenção do Carro",
                    Valor = 120.95m,
                    DataVencimento = new DateTime(2025, 9, 20),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 9, 04),
                    Descricao = "Material de Escritório",
                    Valor = 30.95m,
                    DataVencimento = new DateTime(2025, 9, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 9, 05),
                    Descricao = "Seguro de Vida",
                    Valor = 40.95m,
                    DataVencimento = new DateTime(2025, 9, 05),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 10, 01),
                    Descricao = "Conta de Internet",
                    Valor = 60.95m,
                    DataVencimento = new DateTime(2025, 10, 10),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 10, 02),
                    Descricao = "Aluguel",
                    Valor = 800.95m,
                    DataVencimento = new DateTime(2025, 10, 15),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 10, 03),
                    Descricao = "Manutenção do Carro",
                    Valor = 100.95m,
                    DataVencimento = new DateTime(2025, 10, 20),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Outros")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 10, 04),
                    Descricao = "Material de Escritório",
                    Valor = 40.95m,
                    DataVencimento = new DateTime(2025, 10, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Descricao = "Seguro de Vida",
                    Valor = 40.95m,
                    DataVencimento = new DateTime(2025, 10, 05),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 11, 01),
                    Descricao = "Conta de Água",
                    Valor = 40.95m,
                    DataVencimento = new DateTime(2025, 11, 10),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 11, 02),
                    Descricao = "Aluguel",
                    Valor = 800.95m,
                    DataVencimento = new DateTime(2025, 11, 15),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 11, 04),
                    Descricao = "Material de Escritório",
                    Valor = 35.95m,
                    DataVencimento = new DateTime(2025, 11, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Descricao = "Seguro de Vida",
                    Valor = 40.95m,
                    DataVencimento = new DateTime(2025, 11, 05),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
                ...
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 12, 02),
                    Descricao = "Aluguel",
                    Valor = 800.95m,
                    DataVencimento = new DateTime(2025, 12, 15),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Casa")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 12, 03),
                    Descricao = "Manutenção do Carro",
                    Valor = 80.95m,
                    DataVencimento = new DateTime(2025, 12, 20),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Data = new DateTime(2025, 12, 04),
                    Descricao = "Material de Escritório",
                    Valor = 30.95m,
                    DataVencimento = new DateTime(2025, 12, 25),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Serviços")).Id
                },
                new Despesa
                {
                    ...
                    Descricao = "Seguro de Vida",
                    Valor = 40.95m,
                    DataVencimento = new DateTime(2025, 12, 05),
                    Usuario = user,
                    UsuarioId = user.Id,
                    CategoriaId = _context.Categoria.FirstOrDefault(c => c.UsuarioId == user.Id && c.Descricao.Equals("Saúde")).Id
                },
