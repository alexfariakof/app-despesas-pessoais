...
public sealed class LancamentoParserTest
{
    ...
    public void Should_Parse_Despesa_To_Lancamento()
    {
        ...
        var origin = DespesaFaker.Instance.GetNewFaker(
            usuario,
            CategoriaFaker.Instance.GetNewFaker(usuario, (int)TipoCategoria.CategoriaType.Despesa, usuario.Id)
        );
    ...
    public void Should_Parse_Receita_To_Lancamento()
    {
        ...
        var origin = ReceitaFaker.Instance.GetNewFaker(
            usuario,
            CategoriaFaker.Instance.GetNewFaker(usuario, (int)TipoCategoria.CategoriaType.Receita, usuario.Id)
        );
