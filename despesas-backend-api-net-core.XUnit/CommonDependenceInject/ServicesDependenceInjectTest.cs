...
public class ServicesDependenceInjectTest
{
    ...
    public void AddServices_Should_Register_Services()
    {
        ...
        Assert.NotNull(services.Any(descriptor => descriptor.ServiceType == typeof(IBusiness<Business.Dtos.v1.DespesaDto, Despesa>) && descriptor.ImplementationType == typeof(DespesaBusinessImpl<Business.Dtos.v1.DespesaDto>)));
        Assert.NotNull(services.Any(descriptor => descriptor.ServiceType == typeof(IBusiness<Business.Dtos.v1.ReceitaDto, Receita>) && descriptor.ImplementationType == typeof(ReceitaBusinessImpl<Business.Dtos.v1.ReceitaDto>)));
        Assert.NotNull(services.Any(descriptor => descriptor.ServiceType == typeof(IBusiness<Business.Dtos.v1.CategoriaDto, Categoria>) && descriptor.ImplementationType == typeof(CategoriaBusinessImpl<Business.Dtos.v1.CategoriaDto>)));
        ...
        Assert.NotNull(services.Any(descriptor => descriptor.ServiceType == typeof(BusinessBase<Business.Dtos.v2.CategoriaDto, Categoria>) && descriptor.ImplementationType == typeof(CategoriaBusinessImpl<Business.Dtos.v2.CategoriaDto>)));
        Assert.NotNull(services.Any(descriptor => descriptor.ServiceType == typeof(BusinessBase<Business.Dtos.v2.DespesaDto, Despesa>) && descriptor.ImplementationType == typeof(DespesaBusinessImpl<Business.Dtos.v2.DespesaDto>)));
        Assert.NotNull(services.Any(descriptor => descriptor.ServiceType == typeof(BusinessBase<Business.Dtos.v2.ReceitaDto, Receita>) && descriptor.ImplementationType == typeof(ReceitaBusinessImpl<Business.Dtos.v2.ReceitaDto>)));

        Assert.NotNull(services.Any(descriptor => descriptor.ServiceType == typeof(IBusiness<Business.Dtos.v2.DespesaDto, Despesa>) && descriptor.ImplementationType == typeof(DespesaBusinessImpl<Business.Dtos.v2.DespesaDto>)));
        Assert.NotNull(services.Any(descriptor => descriptor.ServiceType == typeof(IBusiness<Business.Dtos.v2.ReceitaDto, Receita>) && descriptor.ImplementationType == typeof(ReceitaBusinessImpl<Business.Dtos.v2.ReceitaDto>)));
        Assert.NotNull(services.Any(descriptor => descriptor.ServiceType == typeof(IBusiness<Business.Dtos.v2.CategoriaDto, Categoria>) && descriptor.ImplementationType == typeof(CategoriaBusinessImpl<Business.Dtos.v2.CategoriaDto>)));
