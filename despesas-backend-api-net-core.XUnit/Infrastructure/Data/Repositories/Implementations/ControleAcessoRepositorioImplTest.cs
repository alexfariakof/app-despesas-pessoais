...
namespace Infrastructure.Repositories
{
    ...
    public class ControleAcessoRepositorioImplTest
    {
        ...
        public void Create_Should_Return_True()
        {
            ...
            mockRepository
                .Setup(repo => repo.FindByEmail(It.IsAny<ControleAcesso>()))
        ...
        public void Create_Should_Throws_Exception()
        {
            ...
            mockRepository.Setup(repo => repo.Create(It.IsAny<ControleAcesso>())).Returns(false);
            mockRepository
                .Setup(repo => repo.Create(It.IsAny<ControleAcesso>()))
                .Throws<Exception>();
            ...
            var exception = Assert.Throws<Exception>(
                () => _repository.Object.Create(new ControleAcesso())
            );
        ...
        public void RecoveryPassword_Should_Returns_True() // Metodo não pode ser Testado por motivo do Enviar Email
        {
            ...
            var mockEmailSender = Mock.Get<IEmailSender>(emailSender.Object);
            mockEmailSender
                .Setup(sender => sender.SendEmailPassword(mockControleAcesso.Usuario, "!2345"))
                .Returns(true);
            _repository = new Mock<ControleAcessoRepositorioImpl>(
                MockBehavior.Strict,
                _context,
            ...
            mockRepository
                .Setup(repo => repo.FindByEmail(It.IsAny<ControleAcesso>()))
                .Returns(mockControleAcesso);
            mockRepository
                .Setup(repo => repo.GetUsuarioByEmail(mockControleAcesso.Login))
                .Returns(mockControleAcesso.Usuario);
            mockRepository
                .Setup(repo => repo.RecoveryPassword(mockControleAcesso.Login))
                .Returns(true);
        ...
        public void RecoveryPassword_Should_Returns_False()
        {
            ...
            var mockEmailSender = Mock.Get<IEmailSender>(emailSender.Object);
            mockEmailSender
                .Setup(sender => sender.SendEmailPassword(mockUsuario, String.Empty))
                .Returns(false);
            var repository = new Mock<ControleAcessoRepositorioImpl>(
                mockContext,
                mockEmailSender.Object
            );
        ...
        public void ChangePassword_Should_Returns_True()
        {
            ...
            mockRepository
                ...
                .Returns(controleAcesso);
            mockRepository
                .Setup(repo => repo.ChangePassword(controleAcesso.UsuarioId, "!12345"))
                .Returns(true);
        ...
        public void ChangePassword_Should_Throws_Exception()
        {
            ...
            //var result = mockRepository.Object.ChangePassword(controleAcesso.UsuarioId, "!12345");
            Action result = () =>
                mockRepository.Object.ChangePassword(controleAcesso.UsuarioId, "!12345");
