...
public class ReceitaFaker
{
    ...
    public Receita GetNewFaker(Usuario usuario, Categoria categoria)
    {
        var receitaFaker = new Faker<Receita>()
            ...
            .RuleFor(r => r.Categoria, CategoriaFaker.Instance.GetNewFaker(usuario, TipoCategoria.TipoCategoriaType.Receita, usuario.Id));
    ...
    public List<Receita> Receitas(Usuario? usuario = null, int? idUsuario = null, int count = 10 )
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            var categoria = CategoriaFaker.Instance.GetNewFaker(usuario, TipoCategoria.TipoCategoriaType.Receita, usuario.Id);
