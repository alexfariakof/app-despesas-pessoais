...
public class DespesaFaker
{
    ...
    public Despesa GetNewFaker(Usuario usuario, Categoria categoria)
    {
        var despesaFaker = new Faker<Despesa>()
            ...
            .RuleFor(r => r.Categoria, CategoriaFaker.Instance.GetNewFaker(usuario, TipoCategoria.TipoCategoriaType.Despesa, usuario.Id));
    ...
    public List<Despesa> Despesas(Usuario? usuario = null, int? idUsurio = null, int count = 10)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            var categoria = CategoriaFaker.Instance.GetNewFaker(usuario, TipoCategoria.TipoCategoriaType.Despesa, usuario.Id);
