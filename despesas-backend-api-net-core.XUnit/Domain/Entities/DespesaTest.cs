namespace Test.XUnit.Domain.Entities
{
    public class DespesaTest
    {
        ...
        public void Despesa_Should_Set_Properties_Correctly(int id, string descricao, Decimal valor, int usuarioId, Type typeUsuario, int categoriaId, Type typeCategoria )
        {
