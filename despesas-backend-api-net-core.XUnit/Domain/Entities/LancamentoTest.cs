namespace Test.XUnit.Domain.Entities
{
    public class LancamentoTest
    {
        ...
        public void Lancamento_Should_Set_Properties_Correctly(int id, Decimal valor, string descricao, int usuarioId, Type typeUsuario, int despesaId, Type typeDespesa, int receitaId, Type typeReceita,  int categoriaId, Type typeCategoria)
        {
